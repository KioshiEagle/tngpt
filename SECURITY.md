...
Utilisez l'onglet **[Security](https://github.com/KioshiEagle/tngpt/security/advisories/new)** de ce dépôt GitHub et cliquez sur **"Report a vulnerability"** (Private Vulnerability Reporting). Cela ouvre un rapport privé, visible uniquement par les mainteneurs, dans lequel vous pouvez décrire :
