...
flowchart TB
    ...
    subgraph pipeline["Pipeline d'ingestion"]
        ...
        Vector["mdtoqdrant.py<br/>chunking + embeddings E5"]
    end
    ...
    subgraph external["Services externes"]
        ...
        HF["HuggingFace<br/>modèle E5 (offline)"]
    end
...
flowchart LR
    ...
    C --> D["mdtoqdrant.py<br/>chunking + embeddings E5"]
